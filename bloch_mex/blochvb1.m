...
%	Bloch simulator.
%
%	[mx,my,mz] = blochvb1(b1,gr,tp,t1,t2,df,dp,dv,b1scale,mode,mx,my,mz)
%
...
%       dv = (Px1,2,or 3) Array of velocities positions (cm/s).
%			Width should match width of gr.
%       df = (Nx1) Array of b1 scales (fraction of b1 amplitude)
%		mode= Bitmask mode:
